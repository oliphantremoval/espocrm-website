          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-500 text-sm mt-1">
                Tree Removal • Junk Removal • Snow Removal
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-8 text-xl text-gray-600 leading-relaxed max-w-xl">
              Professional tree removal, junk removal, snow removal,
              also emergency services for residential and commercial properties.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Junk Removal',
                desc: 'Professional junk removal services for residential and commercial properties.',
              },
              {
                title: 'Snow Removal',
                desc: 'Driveway and sidewalk snow removal services for residential and commercial properties.',
              },
            ].map((service, index) => (
              <div
                key={index}
